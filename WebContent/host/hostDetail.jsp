...
<body>
	...
	<div id="container">
	<form id="myfrm">
		<fieldset> <legend>호스트정보</legend> <label>ID</label> <input
			type="text" value="${host.host_id }" readonly>
		<br>
		<label>이름</label> <input type="text" value="${host.host_name }"
			readonly>
		<br>
		<label>핸드폰</label> <input type="text" value="${host.host_phone }"
			readonly>
		<br>
