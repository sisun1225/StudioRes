...
<body>
	<div id="ajaxWrap">
		<c:forEach var="listall" items="${studioOption}">
			<div id="card"
				onclick="location.href='${pageContext.request.contextPath}/main/roomDetail?studioid=${listall.studio_no}';">
				...
				<div id="textContainer">
					<span id="searchTextA">${listall.studio_name}</span> <span
						id="searchTextB">
						<p>      
							<img src="${pPath}/main/images/subwayicon.png">
						   
							${listall.studio_subway}
						</p>
