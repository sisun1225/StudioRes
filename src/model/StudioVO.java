...
public class StudioVO {
	...
	public StudioVO(int studio_no, int host_no, String studio_desc, String studio_name, String studio_picture,
			String studio_days, String studio_notice, String studio_subway, String studio_address, String studio_check,
			String studio_have_mic, String studio_have_park, String studio_have_shower, String studio_have_water,
			String studio_have_aircon, String studio_have_heater, String studio_have_toilet) {
		super();
	...
	public String toString() {
		return "StudioVO [studio_no=" + studio_no + ", host_no=" + host_no + ", studio_desc=" + studio_desc
				+ ", studio_name=" + studio_name + ", studio_picture=" + studio_picture + ", studio_days=" + studio_days
				+ ", studio_notice=" + studio_notice + ", studio_subway=" + studio_subway + ", studio_address="
				+ studio_address + ", studio_check=" + studio_check + ", studio_have_mic=" + studio_have_mic
				+ ", studio_have_park=" + studio_have_park + ", studio_have_shower=" + studio_have_shower
				+ ", studio_have_water=" + studio_have_water + ", studio_have_aircon=" + studio_have_aircon
				+ ", studio_have_heater=" + studio_have_heater + ", studio_have_toilet=" + studio_have_toilet + "]";
	}
